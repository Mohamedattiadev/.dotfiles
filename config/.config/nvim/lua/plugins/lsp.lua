...
--     lspconfig.solargraph.setup({ capabilities = lsp_capabilities })
...
--
--     -- Customize LSP floating preview popups
  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd("LspAttach", {
      ...
      callback = function(ev)
        ...
        keymap.set("n", "<leader>db", vim.diagnostic.goto_prev, opts) -- jump to previous diagnostic in buffer
